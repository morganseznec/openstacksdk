...
class TestFirewallPolicy(testtools.TestCase):
    ...
    def test_basic(self):
        sot = firewall_v1_policy.FirewallV1Policy()
        self.assertEqual('firewall_v1_policy', sot.resource_key)
        self.assertEqual('firewall_v1_policies', sot.resources_key)
        self.assertEqual('/fw/firewall_policies', sot.base_path)
    ...
    def test_make_it(self):
        sot = firewall_v1_policy.FirewallV1Policy(**EXAMPLE)
