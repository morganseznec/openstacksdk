...
class FirewallV1Rule(resource.Resource):
    resource_key = 'firewall_v1_rule'
    resources_key = 'firewall_v1_rules'
    base_path = '/fw/firewall_rules'
    ...
    _query_mapping = resource.QueryParameters(
        ...
        'destination_port', 'enabled', 'ip_version', 'project_id', 'tenant_id', 'protocol',
