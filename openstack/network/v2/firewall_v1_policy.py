...
class FirewallV1Policy(resource.Resource):
    resource_key = 'firewall_v1_policy'
    resources_key = 'firewall_v1_policies'
    base_path = '/fw/firewall_policies'
    ...
    firewall_policies = resource.Body('firewall_policies')
